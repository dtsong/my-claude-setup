...
| [distributed-patterns](distributed-patterns/SKILL.md) | Distributed system coordination and consistency | default | `distributed`, `consensus`, `partition`, `saga`, `CRDT`, `event sourcing`, `microservices` |
...
| Request involves distributed systems, consensus, sagas, CRDTs, event sourcing, or partition handling | distributed-patterns | High |
| Request mentions microservices coordination, eventual consistency, or distributed transactions | distributed-patterns | Medium |
